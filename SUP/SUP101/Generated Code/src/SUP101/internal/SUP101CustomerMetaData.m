...
- (id)init
{
    if (self = [super init]) {
		...
		SUPRelationshipMetaData* a_salesOrders = [SUPRelationshipMetaData attributeMetaDataWith:
			10:
			[SUPDataType forName:@"Sales_order*"]:@"LONG VARCHAR":@"salesOrders":@"":@"l":
			@"":-1:0:0:
			@"null":NO:@"":
			NO:NO:NO:NO:YES:YES:
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_salesOrders setColumn:nil];
		...
		[attributes addThis:a_salesOrders];
		...
		[o_getSize_1 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_getSalesOrdersFilterBy_1 = [SUPOperationMetaData createOperationMetaData:15:(SUPString)@"getSalesOrdersFilterBy":[SUPDataType forName:@"Sales_order*"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
	 		SUPParameterMetaData* p_getSalesOrdersFilterBy_query = [SUPParameterMetaData createParameterMetaData:1:(SUPString)@"query":[SUPDataType forName:@"com.sybase.persistence.Query"]];
 			parameters_list = [SUPObjectList listWithCapacity:1];
			[parameters_list addThis:p_getSalesOrdersFilterBy_query];
			o_getSalesOrdersFilterBy_1.parameters = parameters_list;
	 	}
		[o_getSalesOrdersFilterBy_1 setIsStatic:NO];
		[o_getSalesOrdersFilterBy_1 setIsCreate:NO];
		[o_getSalesOrdersFilterBy_1 setIsUpdate:NO];
		[o_getSalesOrdersFilterBy_1 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_getSalesOrdersSize_1 = [SUPOperationMetaData createOperationMetaData:16:(SUPString)@"getSalesOrdersSize":[SUPDataType forName:@"int"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
	 		SUPParameterMetaData* p_getSalesOrdersSize_query = [SUPParameterMetaData createParameterMetaData:1:(SUPString)@"query":[SUPDataType forName:@"com.sybase.persistence.Query"]];
 			parameters_list = [SUPObjectList listWithCapacity:1];
			[parameters_list addThis:p_getSalesOrdersSize_query];
			o_getSalesOrdersSize_1.parameters = parameters_list;
	 	}
		[o_getSalesOrdersSize_1 setIsStatic:NO];
		[o_getSalesOrdersSize_1 setIsCreate:NO];
		[o_getSalesOrdersSize_1 setIsUpdate:NO];
		[o_getSalesOrdersSize_1 setIsDelete:NO]; 		
 		...
 		[operations addThis:o_getSalesOrdersFilterBy_1];
 		[operations addThis:o_getSalesOrdersSize_1];
    	...
    	a_salesOrders.cascadeString = @"save,create,update,delete";
		a_salesOrders.inverseEntity = @"Sales_order";
		a_salesOrders.inverseAttribute = @"customer";
        [self.relationList add:a_salesOrders];
        [self.relationMap setObject:a_salesOrders forKey:a_salesOrders.name];
