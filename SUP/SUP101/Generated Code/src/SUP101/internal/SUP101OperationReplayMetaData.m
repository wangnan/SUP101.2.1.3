...
@implementation SUP101OperationReplayMetaData

+ (SUP101OperationReplayMetaData*)getInstance
{
    return [[[SUP101OperationReplayMetaData alloc] init] autorelease];
}

- (id)init
{
    if (self = [super init]) {
		self.id = _ENTITY_NUMBER_FOR_SUP101OperationReplay_;
		self.name = @"OperationReplay";
		self.klass = [SUP101OperationReplay class];
		...
		self.table = @"sup101_1_0_operationreplay";
