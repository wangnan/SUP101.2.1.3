...
@implementation SUP101LogRecordImpl
...
static SUPEntityDelegate *g_SUP101LogRecordImpl_delegate = nil;

+ (SUPEntityDelegate *) delegate
{
	@synchronized(self) {
		if (g_SUP101LogRecordImpl_delegate == nil) {
			g_SUP101LogRecordImpl_delegate = [[SUPEntityDelegate alloc] initWithName:@"SUP101LogRecordImpl" clazz:[self class]
				metaData:[self metaData] dbDelegate:[SUP101SUP101DB delegate] database:[SUP101SUP101DB instance]];
		}
	}
	
	return [[g_SUP101LogRecordImpl_delegate retain] autorelease];
}

static SUPEntityMetaDataRBS* SUP101LogRecordImpl_META_DATA;

+ (SUPEntityMetaDataRBS*)metaData
{
    if (SUP101LogRecordImpl_META_DATA == nil) {
		SUP101LogRecordImpl_META_DATA = [[SUP101LogRecordImplMetaData alloc] init];
	}
	
	return SUP101LogRecordImpl_META_DATA;
}
...
- (id) init
{
    if ((self = [super init]))
    {
        self.classMetaData = [SUP101LogRecordImpl metaData];
        [self setEntityDelegate:(SUPEntityDelegate*)[SUP101LogRecordImpl delegate]];
    }
    return self;    
}
...
+ (SUP101LogRecordImpl*)find:(int64_t)id_
{
    ...
    return (SUP101LogRecordImpl*)[(SUPEntityDelegate*)([[self class] delegate]) findEntityWithKeys:keys];
}

+ (SUPObjectList*)findWithQuery:(SUPQuery*)query
{
    return (SUPObjectList*)[(SUPEntityDelegate*)([[self class] delegate])  findWithQuery:query:[SUP101LogRecordImpl class]];
}
...
+ (SUP101LogRecordImpl*)load:(int64_t)id_
{
    return (SUP101LogRecordImpl*)[(SUPEntityDelegate*)([[self class] delegate]) load:[NSNumber numberWithLong:id_]];
}

+ (SUP101LogRecordImpl*)getInstance
{
    SUP101LogRecordImpl* me = [[SUP101LogRecordImpl alloc] init];
    [me autorelease];
    return me;
}
...
- (SUP101LogRecordImpl*)getDownloadState
{
    return (SUP101LogRecordImpl*)[self i_getDownloadState];
}

- (SUP101LogRecordImpl*) getOriginalState
{
    return (SUP101LogRecordImpl*)[self i_getOriginalState];
}
...
{
   return [SUP101LogRecordImpl findByEntity:@"LogRecordImpl":[self keyToString]];
}
...
+ (SUPObjectList *)findByEntity:(NSString*)entityName:(NSString*)keyValue
{
    ...
    SUPObjectList *logList = [SUP101LogRecordImpl findWithQuery:query];
    return logList;    
}
