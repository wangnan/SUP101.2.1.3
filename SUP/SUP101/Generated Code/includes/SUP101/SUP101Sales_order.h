...
@interface SUP101Sales_order : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData>
{
@private
    int32_t _id;
    int32_t _cust_id;
    NSDate* _order_date;
    NSString* _fin_code_id;
    NSString* _region;
    int32_t _sales_rep;
    SUP101Customer* _customer;
    BOOL _customerValid;
...
@property(assign,nonatomic) int32_t cust_id;
@property(retain,nonatomic) NSDate* order_date;
@property(retain,nonatomic) NSString* fin_code_id;
@property(retain,nonatomic) NSString* region;
@property(assign,nonatomic) int32_t sales_rep;
@property(retain,nonatomic) SUP101Customer* customer;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (SUP101Sales_order*)load:(int64_t)id;
/*!
  @method 
...
+ (SUPObjectList*)getSalesOrders_for_Customer:(NSNumber*)surrogateKey;
...
+ (SUPObjectList*)getSalesOrders_for_Customer:(NSNumber*)surrogateKey skip:(int32_t)skip take:(int32_t)take;
/*!
  @method
...
@end
typedef SUPObjectList SUP101Sales_orderList;

// internal methods declaration, only used by generated code.
@interface SUP101Sales_order(internal)
